...
extension UIView {
    ...
    public func anchor(top: NSLayoutYAxisAnchor? = nil,
        ...
        if let left = left {
            trailingAnchor.constraint(equalTo: left, constant: paddingLeft).isActive = true
        }
        ...
        if let right = right {
            leadingAnchor.constraint(equalTo: right, constant: -paddingRight).isActive = true
        }
    ...
    // Set Dimensions
    public func setDimensions(height: NSLayoutDimension, heightMultiplier: CGFloat, width: NSLayoutDimension, widthMultiplier: CGFloat) {
        translatesAutoresizingMaskIntoConstraints = false
